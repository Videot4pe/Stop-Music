...
- (void)application:(UIApplication *)application didReceiveLocalNotification:(UILocalNotification *)stop    {
...
- (IBAction)start:(id)sender {
    ...
    int b = time_m2 *60;
    int c = a + b;
    UILocalNotification* stop = [[UILocalNotification alloc] init];
    stop.fireDate = [NSDate dateWithTimeIntervalSinceNow:c];
    [[UIApplication sharedApplication] scheduleLocalNotification:stop];
